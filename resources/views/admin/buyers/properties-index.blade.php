...
<div class="dashboard-screen">
  <div class="dashboard-header">
    <h1>All Properties for {{ $buyer->name }}</h1>
    <p>Quick navigation to this buyer’s land, building, and investment preferences.</p>
  </div>

  <div class="module-content">
    <div class="buyer-req-summary">
      <div class="buyer-req-header">
        <h2>Buyer Preference Groups</h2>
      ...
      <div class="buyer-tabs" style="gap: 12px; flex-wrap: wrap;">
        ...
        <a href="{{ route('admin.buyer.properties.index', ['buyer' => $buyer->id, 'tab' => 'investment']) }}"
           ...
           style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">
          All Buyer Investment Preferences
        </a>
      </div>
      ...
      <div style="margin-top: 24px;">
        ...
        @if(($tab ?? 'land') === 'land')
          ...
          @if($landPreferences->isEmpty())
            <p style="font-size:14px; color:#6b7280;">No land preferences found for this buyer.</p>
          @else
        ...
        @if(($tab ?? 'land') === 'building')
          ...
          @if($buildingPreferences->isEmpty())
            <p style="font-size:14px; color:#6b7280;">No building preferences found for this buyer.</p>
          @else
            <div class="table-responsive">
        ...
        @if(($tab ?? 'land') === 'investment')
          ...
          @if($investmentPreferences->isEmpty())
            <p style="font-size:14px; color:#6b7280;">No investment preferences found for this buyer.</p>
          @else
            <div class="table-responsive">
