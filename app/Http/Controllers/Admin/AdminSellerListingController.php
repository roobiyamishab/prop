...
class AdminSellerListingController extends Controller
{
    /* =========================================================
     |  LAND – STORE (ADMIN CREATING LISTING FOR A USER)
     |  Route example: POST /admin/seller/{user}/land
     ==========================================================*/
    public function storeLand(Request $request, User $user)
    {
        ...
        // Admin chooses which user; we use $user->id
        $userId = $user->id;
        ...
        return back()->with('success', 'Land listing submitted successfully (admin).');
    }

    /* =========================================================
     |  BUILDING – STORE (ADMIN)
     |  Route: POST /admin/seller/{user}/building
     ==========================================================*/
    public function storeBuilding(Request $request, User $user)
    {
        ...
        return back()->with('success', 'Building listing submitted successfully (admin).');
    }

    /* =========================================================
     |  INVESTMENT – STORE (ADMIN)
     |  Route: POST /admin/seller/{user}/investment
     ==========================================================*/
    public function storeInvestment(Request $request, User $user)
    {
        $data = $request->validate([
        ...
        return back()->with('success', 'Investment opportunity submitted successfully (admin).');
    }

    /* =========================================================
     |  STATUS UPDATES (ADMIN)
     ==========================================================*/
    public function updateLandStatus(Request $request, SellerLandListing $land)
    {
        $data = $request->validate([
        ...
        return back()->with('success', 'Land listing status updated (admin).');
    }

    public function updateBuildingStatus(Request $request, SellerBuildingListing $building)
    {
        $data = $request->validate([
            'status' => ['required', 'string', 'in:normal,hot,urgent,sold,closed'],
        ]);
        ...
        return back()->with('success', 'Building listing status updated (admin).');
    }

    public function updateInvestmentStatus(Request $request, SellerInvestmentListing $inv)
    {
        $data = $request->validate([
            'status' => ['required', 'string', 'in:normal,hot,urgent,sold,closed'],
        ]);
        ...
        return back()->with('success', 'Investment listing status updated (admin).');
    }
    ...
    public function updateLand(Request $request, SellerLandListing $land)
    {
        ...
        return back()->with('success', 'Land listing updated successfully (admin).');
    }

    /* =========================================================
     |  BUILDING UPDATE (ADMIN)
     ==========================================================*/
    public function updateBuilding(Request $request, SellerBuildingListing $building)
    {
        ...
        return back()->with('success', 'Building listing updated successfully (admin).');
    }

    /* =========================================================
     |  INVESTMENT UPDATE (ADMIN)
     ==========================================================*/
    public function updateInvestment(Request $request, SellerInvestmentListing $investment)
    {
        ...
        return back()->with('success', 'Investment listing updated successfully (admin).');
    }

    /* =========================================================
     |  PROPERTY CODE GENERATOR (same logic)
     ==========================================================*/
